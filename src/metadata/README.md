 ...
 * [deep.yml](deep.yml)
     * Determines how your purl.obolibrary.org/obo/deep/ redirects will be handled
     ...
     * Paste in the contents of [deep.yml](deep.yml)
 ...
 * [deep.md](deep.md)
     ...
     * Paste in the contents of [deep.md](deep.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
